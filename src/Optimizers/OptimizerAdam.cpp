...
OptimizerAdam::OptimizerAdam(double lr, double dr, double e, double b1, double b2) {
    learningRate = lr;
...
double OptimizerAdam::getLearningRate() {
...
void OptimizerAdam::updateParameters(DenseLayer* layer) {
...
void OptimizerAdam::incrementIteration() {
    iteration++;
}